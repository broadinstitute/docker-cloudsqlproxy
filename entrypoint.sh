...
exec ${CLOUDSQL_PROXY_CMD}  -max_connections=${CLOUDSQL_MAXCONNS} -instances=${CLOUDSQL_CONNECTION_LIST} -term_timeout=${TERM_TIMEOUT} ${CREDENTIALS}  ${CLOUDSQL_LOGGING}
